...
<details> 
	...
	<h4>로그인/로그아웃(회원)</h4>
	<img src="./infra/product/gif/login_logout.gif" width="80%"/> 
	<br>
    <h4>로그인/로그아웃(관리자)</h4>
    <img src="./infra/product/gif/admin_login_logout.gif" width="80%"/> 
</details>  
<details> 
	<summary><b>📚 개인 서재 관리</b></summary>
	<h4>나의 서재 기능</h4>
	<img src="./infra/product/gif/mylib.gif" width="80%"//>
</details> 

<details> 
	<summary><b> 👤 마이페이지</b></summary> 
    <img src="./infra/product/gif/마이페이지.gif" width="80%"/> 
	<br>
</details> 
...
<details> 
	...
	<h4>글귀 등록</h4>
	<img src="./infra/product/gif/글귀등록.gif" width="80%"/>
	<h4>글귀 수정/삭제</h4>
	<img src="./infra/product/gif/글귀수정삭제.gif" width="80%"/>
</details> 

<details> 
    <summary><b>💬 글귀 스레드</b></summary>
	<h4>스레드 목록 조회</h4>
	<img src="./infra/product/gif/스레드목록조회.gif" width="80%"/>
	<h4>스레드 등록</h4>
	<img src="./infra/product/gif/스레드등록.gif" width="80%"/>
	<h4>스레드 상세 조회</h4>
	<img src="./infra/product/gif/스레드상세조회.gif" width="80%"/>
	<h4>스레드 답글 등록</h4>
	<img src="./infra/product/gif/스레드답글등록.gif" width="80%"/>
	<h4>스레드 답글 수정</h4>
	<img src="./infra/product/gif/스레드답글수정.gif" width="80%"/>
	<h4>스레드 답글 삭제</h4>
	<img src="./infra/product/gif/스레드답글삭제.gif" width="80%"/>
	<h4>스레드 삭제</h4>
	<img src="./infra/product/gif/스레드삭제.gif" width="80%"/>
</details>

<details> 
	<summary><b>🔔 알림</b></summary> 
	<h4>알림 템플릿 목록 조회</h4>
	<img src="./infra/product/gif/알림템플릿목록조회.gif" width="80%"/>
	<h4>알림 템플릿 검색</h4>
	<img src="./infra/product/gif/알림템플릿검색.gif" width="80%"/>
	<h4>알림 템플릿 상세 조회</h4>
	<img src="./infra/product/gif/알림템플릿상세조회.gif" width="80%"/>
	<h4>알림 템플릿 등록</h4>
	<img src="./infra/product/gif/알림템플릿등록.gif" width="80%"/>
	<h4>알림 템플릿 수정</h4>
	<img src="./infra/product/gif/알림템플릿수정.gif" width="80%"/>
	<h4>알림 템플릿 삭제</h4>
	<img src="./infra/product/gif/알림템플릿삭제.gif" width="80%"/>
	<h4>알림 로그 검색</h4>
	<img src="./infra/product/gif/알림로그검색.png" width="80%"/>
	<h4>알림 발송</h4>
	<img src="./infra/product/gif/알림발송.gif" width="80%"/>
	<h4>알림함</h4>
	<img src="./infra/product/gif/알림함.gif" width="80%"/>
	<h4>스레드 답글 알림</h4>
	<img src="./infra/product/gif/스레드답글알림.gif" width="80%"/>
</details>

<details> 
	<summary><b>🚨 신고</b></summary> 
	<h4>신고 목록 조회</h4>
	<img src="./infra/product/gif/신고필터.gif" width="80%"/>
	<h4>신고 처리</h4>
	<img src="./infra/product/gif/신고처리.gif" width="80%"/>
	<h4>게시물 신고 접수</h4>
	<img src="./infra/product/gif/게시물신고접수.gif" width="80%"/>
